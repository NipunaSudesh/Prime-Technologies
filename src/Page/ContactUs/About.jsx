...
export const About = () => {
  return (
    ...
    <h1 className='text-2xl font-semibold text-textColor mb-2'>Prime Technologies</h1>
    <p className='text-textColor mb-2'>Est. 2018, we're a leading software development firm in Sri Lanka, elevating businesses through cutting-edge tech and dedicated teams.</p>
    <div className='flex flex-col'>
        <h2 className='text-xl text-textColor'>Follow us on</h2>
